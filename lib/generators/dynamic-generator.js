...
// NOTE : THIS IS W.I.P, not really working right now
...
var async = require('async'),
    path = require('path'),
    genUtils = require('./generators-utils'),
    faker = require('faker');
    ...
    Object.keys(self._fields).forEach(function(key, pos) {
        ...
        if (Array.isArray(field)) {
            ...
            fieldGenerator.fn = function(range) {
                return genUtils.getRandomBetween(range);
            };
        }
        // { lastname : 'LastName'}
...
var simpleModel = new ModelGenerator({
    ...
    __dynamicFields: [{
        ...
        after: function(generator) {
            ...
            if (!pw) {
                var pwLength = genUtils.getRandomBetween(generator.ranges.passwordLength);
