...
class Utilities {
     ...
     */
    static getFormattedRange(obj, ignoreValidation) {
        let formattedRange = {};
     ...
     */
    static getRangesFromOptions(defaultRanges, options) {
        ...
        for (let range in ranges) {
            ...
            let defaults = this.getFormattedRange(defaultRanges[range]);
            if (options && options[range]) {
                ranges[range] = this.getFormattedRange(options[range], true);
     ...
     */
    static validateRequiredOptions(fields, options) {
